...
# Company Intel: Violet Ink

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=violet-ink --refresh`
...
**Search query:**
```
Violet Ink company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Violet Ink" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Violet Ink" funding stage investors
```
...
**Search query:**
```
"Violet Ink" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Violet Ink" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Violet Ink" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
