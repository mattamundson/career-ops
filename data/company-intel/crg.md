...
> Re-generate with: `node scripts/company-intel.mjs --company=crg --refresh`
...
**Search query:**
```
CRG company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "CRG" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "CRG" funding stage investors
```
...
**Search query:**
```
"CRG" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"CRG" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"CRG" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
