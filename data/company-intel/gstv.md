...
> Re-generate with: `node scripts/company-intel.mjs --company=gstv --refresh`
...
**Search query:**
```
gstv company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "gstv" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "gstv" funding stage investors
```
...
**Search query:**
```
"gstv" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"gstv" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"gstv" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
