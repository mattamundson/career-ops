...
**Search query:**
```
FutureStack AI Inc company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "FutureStack AI Inc" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "FutureStack AI Inc" funding stage investors
```
...
**Search query:**
```
"FutureStack AI Inc" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"FutureStack AI Inc" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"FutureStack AI Inc" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
