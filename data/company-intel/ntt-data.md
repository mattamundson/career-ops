...
**Search query:**
```
NTT DATA company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "NTT DATA" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "NTT DATA" funding stage investors
```
...
**Search query:**
```
"NTT DATA" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"NTT DATA" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"NTT DATA" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
