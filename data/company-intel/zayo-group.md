...
# Company Intel: Zayo Group

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=zayo-group --refresh`
...
**Search query:**
```
Zayo Group company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Zayo Group" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Zayo Group" funding stage investors
```
...
**Search query:**
```
"Zayo Group" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Zayo Group" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Zayo Group" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
