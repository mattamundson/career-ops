...
# Company Intel: Mayo Clinic

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=mayo-clinic --refresh`
...
**Search query:**
```
Mayo Clinic company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Mayo Clinic" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Mayo Clinic" funding stage investors
```
...
**Search query:**
```
"Mayo Clinic" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Mayo Clinic" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Mayo Clinic" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
