...
**Search query:**
```
Mastech Digital company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Mastech Digital" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Mastech Digital" funding stage investors
```
...
**Search query:**
```
"Mastech Digital" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Mastech Digital" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Mastech Digital" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
