---
company: Trajectory Recruiting
slug: trajectory-recruiting
last_updated: 2026-04-09
source: company-intel.mjs (generated template)
---

# Company Intel: Trajectory Recruiting

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=trajectory-recruiting --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | Trajectory Recruiting |
...
**Search query:**
```
Trajectory Recruiting company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Trajectory Recruiting" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Trajectory Recruiting" funding stage investors
```
...
**Search query:**
```
"Trajectory Recruiting" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Trajectory Recruiting" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Trajectory Recruiting" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
