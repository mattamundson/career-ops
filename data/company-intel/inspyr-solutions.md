...
**Search query:**
```
INSPYR Solutions company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "INSPYR Solutions" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "INSPYR Solutions" funding stage investors
```
...
**Search query:**
```
"INSPYR Solutions" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"INSPYR Solutions" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"INSPYR Solutions" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
