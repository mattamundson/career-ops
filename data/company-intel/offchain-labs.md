...
# Company Intel: Offchain Labs

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=offchain-labs --refresh`
...
**Search query:**
```
Offchain Labs company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Offchain Labs" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Offchain Labs" funding stage investors
```
...
**Search query:**
```
"Offchain Labs" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Offchain Labs" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Offchain Labs" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
