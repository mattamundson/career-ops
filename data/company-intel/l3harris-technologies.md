...
# Company Intel: L3Harris Technologies

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=l3harris-technologies --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | L3Harris Technologies |
...
**Search query:**
```
L3Harris Technologies company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "L3Harris Technologies" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "L3Harris Technologies" funding stage investors
```
...
**Search query:**
```
"L3Harris Technologies" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"L3Harris Technologies" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"L3Harris Technologies" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
