...
# Company Intel: RandomTrees

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=randomtrees --refresh`
...
**Search query:**
```
RandomTrees company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "RandomTrees" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "RandomTrees" funding stage investors
```
...
**Search query:**
```
"RandomTrees" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"RandomTrees" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"RandomTrees" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
