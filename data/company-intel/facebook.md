...
**Search query:**
```
Facebook company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Facebook" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Facebook" funding stage investors
```
...
**Search query:**
```
"Facebook" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Facebook" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Facebook" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
