...
**Search query:**
```
ScaleneWorks INC company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "ScaleneWorks INC" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "ScaleneWorks INC" funding stage investors
```
...
**Search query:**
```
"ScaleneWorks INC" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"ScaleneWorks INC" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"ScaleneWorks INC" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
