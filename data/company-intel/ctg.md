...
> Re-generate with: `node scripts/company-intel.mjs --company=ctg --refresh`
...
**Search query:**
```
CTG company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "CTG" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "CTG" funding stage investors
```
...
**Search query:**
```
"CTG" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"CTG" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"CTG" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
