...
**Search query:**
```
Scale AI company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Scale AI" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Scale AI" funding stage investors
```
...
**Search query:**
```
"Scale AI" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Scale AI" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Scale AI" after:2026-01-10 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
