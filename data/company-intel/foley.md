...
> Re-generate with: `node scripts/company-intel.mjs --company=foley --refresh`
...
**Search query:**
```
Foley company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Foley" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Foley" funding stage investors
```
...
**Search query:**
```
"Foley" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Foley" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Foley" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
