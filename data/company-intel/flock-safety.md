...
# Company Intel: Flock Safety

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=flock-safety --refresh`
...
**Search query:**
```
Flock Safety company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Flock Safety" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Flock Safety" funding stage investors
```
...
**Search query:**
```
"Flock Safety" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Flock Safety" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Flock Safety" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
