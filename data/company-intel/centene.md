...
**Search query:**
```
Centene company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Centene" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Centene" funding stage investors
```
...
**Search query:**
```
"Centene" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Centene" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Centene" after:2026-01-10 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
