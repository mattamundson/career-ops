...
# Company Intel: LVI Associates

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=lvi-associates --refresh`
...
**Search query:**
```
LVI Associates company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "LVI Associates" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "LVI Associates" funding stage investors
```
...
**Search query:**
```
"LVI Associates" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"LVI Associates" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"LVI Associates" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
