...
> Re-generate with: `node scripts/company-intel.mjs --company=k1x --refresh`
...
**Search query:**
```
k1x company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "k1x" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "k1x" funding stage investors
```
...
**Search query:**
```
"k1x" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"k1x" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"k1x" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
