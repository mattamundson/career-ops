...
**Search query:**
```
Vertical Relevance company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Vertical Relevance" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Vertical Relevance" funding stage investors
```
...
**Search query:**
```
"Vertical Relevance" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Vertical Relevance" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Vertical Relevance" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
