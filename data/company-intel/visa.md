...
> Re-generate with: `node scripts/company-intel.mjs --company=visa --refresh`
...
**Search query:**
```
Visa company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Visa" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Visa" funding stage investors
```
...
**Search query:**
```
"Visa" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Visa" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Visa" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
