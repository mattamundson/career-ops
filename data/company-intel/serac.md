...
> Re-generate with: `node scripts/company-intel.mjs --company=serac --refresh`
...
**Search query:**
```
Serac company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Serac" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Serac" funding stage investors
```
...
**Search query:**
```
"Serac" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Serac" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Serac" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
