...
**Search query:**
```
Fractal company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Fractal" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Fractal" funding stage investors
```
...
**Search query:**
```
"Fractal" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Fractal" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Fractal" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
