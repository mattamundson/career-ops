...
**Search query:**
```
Aspire Software company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Aspire Software" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Aspire Software" funding stage investors
```
...
**Search query:**
```
"Aspire Software" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Aspire Software" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Aspire Software" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
