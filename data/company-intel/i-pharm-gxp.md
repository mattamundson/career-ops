...
# Company Intel: i-Pharm GxP

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=i-pharm-gxp --refresh`
...
**Search query:**
```
i-Pharm GxP company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "i-Pharm GxP" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "i-Pharm GxP" funding stage investors
```
...
**Search query:**
```
"i-Pharm GxP" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"i-Pharm GxP" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"i-Pharm GxP" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
