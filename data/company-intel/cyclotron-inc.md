...
# Company Intel: Cyclotron, Inc.

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=cyclotron-inc --refresh`
...
**Search query:**
```
Cyclotron, Inc. company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Cyclotron, Inc." reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Cyclotron, Inc." funding stage investors
```
...
**Search query:**
```
"Cyclotron, Inc." employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Cyclotron, Inc." salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Cyclotron, Inc." after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
