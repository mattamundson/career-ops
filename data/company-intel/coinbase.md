...
**Search query:**
```
Coinbase company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Coinbase" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Coinbase" funding stage investors
```
...
**Search query:**
```
"Coinbase" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Coinbase" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Coinbase" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
