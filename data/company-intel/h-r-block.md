...
**Search query:**
```
H&R Block company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "H&R Block" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "H&R Block" funding stage investors
```
...
**Search query:**
```
"H&R Block" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"H&R Block" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"H&R Block" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
