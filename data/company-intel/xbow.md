...
> Re-generate with: `node scripts/company-intel.mjs --company=xbow --refresh`
...
**Search query:**
```
XBOW company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "XBOW" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "XBOW" funding stage investors
```
...
**Search query:**
```
"XBOW" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"XBOW" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"XBOW" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
