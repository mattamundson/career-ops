...
> Re-generate with: `node scripts/company-intel.mjs --company=daman --refresh`
...
**Search query:**
```
Daman company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Daman" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Daman" funding stage investors
```
...
**Search query:**
```
"Daman" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Daman" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Daman" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
