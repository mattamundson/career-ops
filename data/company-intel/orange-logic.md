...
# Company Intel: Orange Logic

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=orange-logic --refresh`
...
**Search query:**
```
Orange Logic company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Orange Logic" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Orange Logic" funding stage investors
```
...
**Search query:**
```
"Orange Logic" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Orange Logic" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Orange Logic" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
