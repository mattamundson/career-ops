...
> Re-generate with: `node scripts/company-intel.mjs --company=vultr --refresh`
...
**Search query:**
```
Vultr company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Vultr" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Vultr" funding stage investors
```
...
**Search query:**
```
"Vultr" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Vultr" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Vultr" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
