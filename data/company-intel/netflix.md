...
**Search query:**
```
Netflix company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Netflix" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Netflix" funding stage investors
```
...
**Search query:**
```
"Netflix" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Netflix" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Netflix" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
