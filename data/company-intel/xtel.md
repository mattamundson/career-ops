...
> Re-generate with: `node scripts/company-intel.mjs --company=xtel --refresh`
...
**Search query:**
```
XTEL company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "XTEL" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "XTEL" funding stage investors
```
...
**Search query:**
```
"XTEL" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"XTEL" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"XTEL" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
