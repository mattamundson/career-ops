...
**Search query:**
```
Gopuff company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Gopuff" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Gopuff" funding stage investors
```
...
**Search query:**
```
"Gopuff" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Gopuff" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Gopuff" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
