...
# Company Intel: SlateRx LLC

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=slaterx-llc --refresh`
...
**Search query:**
```
SlateRx LLC company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "SlateRx LLC" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "SlateRx LLC" funding stage investors
```
...
**Search query:**
```
"SlateRx LLC" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"SlateRx LLC" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"SlateRx LLC" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
