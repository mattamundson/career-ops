...
**Search query:**
```
Atmosera company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Atmosera" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Atmosera" funding stage investors
```
...
**Search query:**
```
"Atmosera" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Atmosera" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Atmosera" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
