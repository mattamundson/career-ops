---
company: Autonomai Recruitment
slug: autonomai-recruitment
last_updated: 2026-04-09
source: company-intel.mjs (generated template)
---

# Company Intel: Autonomai Recruitment

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=autonomai-recruitment --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | Autonomai Recruitment |
...
**Search query:**
```
Autonomai Recruitment company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Autonomai Recruitment" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Autonomai Recruitment" funding stage investors
```
...
**Search query:**
```
"Autonomai Recruitment" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Autonomai Recruitment" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Autonomai Recruitment" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
