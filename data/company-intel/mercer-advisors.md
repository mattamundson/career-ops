...
**Search query:**
```
Mercer Advisors company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Mercer Advisors" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Mercer Advisors" funding stage investors
```
...
**Search query:**
```
"Mercer Advisors" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Mercer Advisors" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Mercer Advisors" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
