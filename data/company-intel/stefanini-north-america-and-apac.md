...
slug: stefanini-north-america-and-apac
last_updated: 2026-04-09
source: company-intel.mjs (generated template)
---

# Company Intel: Stefanini North America and APAC

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=stefanini-north-america-and-apac --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | Stefanini North America and APAC |
...
**Search query:**
```
Stefanini North America and APAC company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Stefanini North America and APAC" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Stefanini North America and APAC" funding stage investors
```
...
**Search query:**
```
"Stefanini North America and APAC" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Stefanini North America and APAC" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Stefanini North America and APAC" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
