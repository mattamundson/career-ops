...
**Search query:**
```
Experian company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Experian" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Experian" funding stage investors
```
...
**Search query:**
```
"Experian" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Experian" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Experian" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
