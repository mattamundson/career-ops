...
**Search query:**
```
Panopto company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Panopto" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Panopto" funding stage investors
```
...
**Search query:**
```
"Panopto" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Panopto" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Panopto" after:2026-01-08 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
