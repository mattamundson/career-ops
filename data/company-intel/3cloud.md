...
**Search query:**
```
3Cloud company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "3Cloud" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "3Cloud" funding stage investors
```
...
**Search query:**
```
"3Cloud" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"3Cloud" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"3Cloud" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
