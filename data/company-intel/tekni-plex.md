...
# Company Intel: Tekni-Plex

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=tekni-plex --refresh`
...
**Search query:**
```
Tekni-Plex company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Tekni-Plex" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Tekni-Plex" funding stage investors
```
...
**Search query:**
```
"Tekni-Plex" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Tekni-Plex" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Tekni-Plex" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
