...
> Re-generate with: `node scripts/company-intel.mjs --company=agility-robotics --refresh`
...
**Search query:**
```
Agility Robotics company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Agility Robotics" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Agility Robotics" funding stage investors
```
...
**Search query:**
```
"Agility Robotics" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Agility Robotics" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Agility Robotics" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
