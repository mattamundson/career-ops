...
**Search query:**
```
Mastek company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Mastek" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Mastek" funding stage investors
```
...
**Search query:**
```
"Mastek" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Mastek" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Mastek" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
