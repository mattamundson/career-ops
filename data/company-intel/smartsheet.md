...
# Company Intel: Smartsheet

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=smartsheet --refresh`
...
**Search query:**
```
Smartsheet company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Smartsheet" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Smartsheet" funding stage investors
```
...
**Search query:**
```
"Smartsheet" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Smartsheet" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Smartsheet" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
