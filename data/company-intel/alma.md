...
> Re-generate with: `node scripts/company-intel.mjs --company=alma --refresh`
...
**Search query:**
```
Alma company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Alma" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Alma" funding stage investors
```
...
**Search query:**
```
"Alma" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Alma" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Alma" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
