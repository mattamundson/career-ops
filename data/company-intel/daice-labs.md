...
# Company Intel: Daice Labs

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=daice-labs --refresh`
...
**Search query:**
```
Daice Labs company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Daice Labs" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Daice Labs" funding stage investors
```
...
**Search query:**
```
"Daice Labs" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Daice Labs" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Daice Labs" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
