...
**Search query:**
```
Coltech company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Coltech" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Coltech" funding stage investors
```
...
**Search query:**
```
"Coltech" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Coltech" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Coltech" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
