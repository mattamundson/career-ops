...
> Re-generate with: `node scripts/company-intel.mjs --company=aegon --refresh`
...
**Search query:**
```
Aegon company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Aegon" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Aegon" funding stage investors
```
...
**Search query:**
```
"Aegon" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Aegon" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Aegon" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
