...
# Company Intel: Alpha Omega

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=alpha-omega --refresh`
...
**Search query:**
```
Alpha Omega company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Alpha Omega" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Alpha Omega" funding stage investors
```
...
**Search query:**
```
"Alpha Omega" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Alpha Omega" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Alpha Omega" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
