...
**Search query:**
```
GitHub company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "GitHub" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "GitHub" funding stage investors
```
...
**Search query:**
```
"GitHub" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"GitHub" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"GitHub" after:2026-01-10 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
