...
# Company Intel: Databricks

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=databricks --refresh`
...
**Search query:**
```
Databricks company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Databricks" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Databricks" funding stage investors
```
...
**Search query:**
```
"Databricks" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Databricks" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Databricks" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
