...
> Re-generate with: `node scripts/company-intel.mjs --company=bd --refresh`
...
**Search query:**
```
BD company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "BD" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "BD" funding stage investors
```
...
**Search query:**
```
"BD" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"BD" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"BD" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
