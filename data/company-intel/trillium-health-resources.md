...
# Company Intel: Trillium Health Resources

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=trillium-health-resources --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | Trillium Health Resources |
...
**Search query:**
```
Trillium Health Resources company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Trillium Health Resources" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Trillium Health Resources" funding stage investors
```
...
**Search query:**
```
"Trillium Health Resources" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Trillium Health Resources" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Trillium Health Resources" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
