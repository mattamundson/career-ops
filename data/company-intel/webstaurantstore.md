...
# Company Intel: WebstaurantStore

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=webstaurantstore --refresh`
...
**Search query:**
```
WebstaurantStore company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "WebstaurantStore" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "WebstaurantStore" funding stage investors
```
...
**Search query:**
```
"WebstaurantStore" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"WebstaurantStore" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"WebstaurantStore" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
