...
# Company Intel: Interwell Health

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=interwell-health --refresh`
...
**Search query:**
```
Interwell Health company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Interwell Health" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Interwell Health" funding stage investors
```
...
**Search query:**
```
"Interwell Health" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Interwell Health" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Interwell Health" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
