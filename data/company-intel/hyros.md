...
> Re-generate with: `node scripts/company-intel.mjs --company=hyros --refresh`
...
**Search query:**
```
Hyros company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Hyros" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Hyros" funding stage investors
```
...
**Search query:**
```
"Hyros" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Hyros" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Hyros" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
