...
slug: modine-manufacturing-company
last_updated: 2026-04-09
source: company-intel.mjs (generated template)
---

# Company Intel: Modine Manufacturing Company

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=modine-manufacturing-company --refresh`
...
**Search query:**
```
Modine Manufacturing Company company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Modine Manufacturing Company" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Modine Manufacturing Company" funding stage investors
```
...
**Search query:**
```
"Modine Manufacturing Company" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Modine Manufacturing Company" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Modine Manufacturing Company" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
