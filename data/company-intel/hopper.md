...
**Search query:**
```
Hopper company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Hopper" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Hopper" funding stage investors
```
...
**Search query:**
```
"Hopper" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Hopper" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Hopper" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
