...
# Company Intel: Anthropic

> Generated 2026-04-08. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=anthropic --refresh`
...
**Search query:**
```
Anthropic company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Anthropic" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Anthropic" funding stage investors
```
...
**Search query:**
```
"Anthropic" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Anthropic" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Anthropic" after:2026-01-08 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
