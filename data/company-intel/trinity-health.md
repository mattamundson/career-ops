...
# Company Intel: Trinity Health

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=trinity-health --refresh`
...
**Search query:**
```
Trinity Health company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Trinity Health" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Trinity Health" funding stage investors
```
...
**Search query:**
```
"Trinity Health" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Trinity Health" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Trinity Health" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
