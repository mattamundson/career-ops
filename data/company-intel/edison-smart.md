...
# Company Intel: Edison Smart®

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=edison-smart --refresh`
...
**Search query:**
```
Edison Smart® company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Edison Smart®" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Edison Smart®" funding stage investors
```
...
**Search query:**
```
"Edison Smart®" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Edison Smart®" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Edison Smart®" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
