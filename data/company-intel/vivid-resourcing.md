...
**Search query:**
```
Vivid Resourcing company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Vivid Resourcing" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Vivid Resourcing" funding stage investors
```
...
**Search query:**
```
"Vivid Resourcing" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Vivid Resourcing" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Vivid Resourcing" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
