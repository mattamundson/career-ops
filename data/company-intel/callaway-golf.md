...
# Company Intel: Callaway Golf

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=callaway-golf --refresh`
...
**Search query:**
```
Callaway Golf company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Callaway Golf" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Callaway Golf" funding stage investors
```
...
**Search query:**
```
"Callaway Golf" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Callaway Golf" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Callaway Golf" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
