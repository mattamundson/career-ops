...
# Company Intel: GSquared Group

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=gsquared-group --refresh`
...
**Search query:**
```
GSquared Group company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "GSquared Group" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "GSquared Group" funding stage investors
```
...
**Search query:**
```
"GSquared Group" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"GSquared Group" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"GSquared Group" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
