...
# Company Intel: Rightworks

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=rightworks --refresh`
...
**Search query:**
```
Rightworks company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Rightworks" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Rightworks" funding stage investors
```
...
**Search query:**
```
"Rightworks" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Rightworks" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Rightworks" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
