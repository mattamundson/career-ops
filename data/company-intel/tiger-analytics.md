...
# Company Intel: Tiger Analytics

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=tiger-analytics --refresh`
...
**Search query:**
```
Tiger Analytics company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Tiger Analytics" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Tiger Analytics" funding stage investors
```
...
**Search query:**
```
"Tiger Analytics" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Tiger Analytics" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Tiger Analytics" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
