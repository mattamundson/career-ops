...
# Company Intel: Mole Street

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=mole-street --refresh`
...
**Search query:**
```
Mole Street company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Mole Street" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Mole Street" funding stage investors
```
...
**Search query:**
```
"Mole Street" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Mole Street" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Mole Street" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
