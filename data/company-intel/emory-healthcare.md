...
# Company Intel: Emory Healthcare

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=emory-healthcare --refresh`
...
**Search query:**
```
Emory Healthcare company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Emory Healthcare" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Emory Healthcare" funding stage investors
```
...
**Search query:**
```
"Emory Healthcare" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Emory Healthcare" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Emory Healthcare" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
