---
company: Constitution Surgery Alliance
slug: constitution-surgery-alliance
last_updated: 2026-04-09
source: company-intel.mjs (generated template)
---

# Company Intel: Constitution Surgery Alliance

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=constitution-surgery-alliance --refresh`
...
| Field | Value |
|-------|-------|
| Full Name | Constitution Surgery Alliance |
...
**Search query:**
```
Constitution Surgery Alliance company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Constitution Surgery Alliance" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Constitution Surgery Alliance" funding stage investors
```
...
**Search query:**
```
"Constitution Surgery Alliance" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Constitution Surgery Alliance" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Constitution Surgery Alliance" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
