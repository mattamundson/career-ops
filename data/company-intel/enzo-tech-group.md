...
**Search query:**
```
Enzo Tech Group company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Enzo Tech Group" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Enzo Tech Group" funding stage investors
```
...
**Search query:**
```
"Enzo Tech Group" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Enzo Tech Group" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Enzo Tech Group" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
