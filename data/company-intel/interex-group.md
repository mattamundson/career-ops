...
# Company Intel: InterEx Group

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=interex-group --refresh`
...
**Search query:**
```
InterEx Group company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "InterEx Group" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "InterEx Group" funding stage investors
```
...
**Search query:**
```
"InterEx Group" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"InterEx Group" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"InterEx Group" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
