...
# Company Intel: Stott and May

> Generated 2026-04-09. Sections marked `<!-- TODO: Fill from search -->` require manual or WebSearch completion.
> Re-generate with: `node scripts/company-intel.mjs --company=stott-and-may --refresh`
...
**Search query:**
```
Stott and May company overview site:crunchbase.com OR site:linkedin.com/company
```
...
**Search query:**
```
site:glassdoor.com "Stott and May" reviews rating
```
...
**Search query:**
```
site:crunchbase.com "Stott and May" funding stage investors
```
...
**Search query:**
```
"Stott and May" employees headcount size LinkedIn OR Glassdoor OR Craft.co OR ZoomInfo
```
...
**Search query:**
```
"Stott and May" salary "data analyst OR data engineer OR analytics engineer" Glassdoor OR Levels.fyi OR Blind OR Glassdoor OR Payscale
```
...
**Search query:**
```
"Stott and May" after:2026-01-09 (announcement OR funding OR layoffs OR acquisition OR product OR expansion)
```
