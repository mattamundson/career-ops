...
3. If match found → load the complete report
4. If Section G exists → load prior draft answers as a starting point
...
5. **Proof point hook**: Always anchor with a real achievement, not a claim
